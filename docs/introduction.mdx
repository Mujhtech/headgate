---
title: "Introduction"
description: "A policy-aware job queue for Rust and Go, backed by PostgreSQL, MySQL, Redis, or SQLite."
icon: "door-open"
---
...
<Columns cols={3}>
  ...
  <Card title="Three stores" icon="database">
    PostgreSQL, MySQL, Redis, and SQLite expose matching core behavior and honest optional capabilities.
  </Card>
</Columns>
