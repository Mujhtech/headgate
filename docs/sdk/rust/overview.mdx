...
Add `headgate-workflow` for durable DAGs, `headgate-crypto` for client-side encrypted
payloads, `headgate-otel` for OpenTelemetry, or `headgate-prometheus` for native Prometheus
metrics. These opt-in layers keep drivers and exporters out of core.
