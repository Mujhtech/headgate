...
require (
	...
	github.com/mujhtech/headgate/go/headgatetest v0.1.0
	github.com/mujhtech/headgate/go/headgateui v0.1.0
)
...
require (
	...
	github.com/mujhtech/headgate/go/headgatemigrate v0.1.0 // indirect
