...
require (
	github.com/mujhtech/headgate/go v0.1.4
	github.com/mujhtech/headgate/go/headgatecrypto v0.1.4
	github.com/mujhtech/headgate/go/headgatetest v0.1.4
	github.com/mujhtech/headgate/go/headgateui v0.1.4
	github.com/mujhtech/headgate/go/headgateworkflow v0.1.4
)
...
require (
	...
	github.com/mujhtech/headgate/go/headgatemigrate v0.1.4 // indirect
