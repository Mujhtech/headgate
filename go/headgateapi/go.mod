...
require github.com/mujhtech/headgate/go/driver/headgatepgx v0.1.6

require github.com/mujhtech/headgate/go/driver/headgateredis v0.1.6

require github.com/mujhtech/headgate/go/driver/headgatemysql v0.1.6

require github.com/mujhtech/headgate/go/headgateui v0.1.6
