...
export function QuarantineView({ notify }: ViewProps) {
  ...
  const { data, error, loading } = useApiResource<{ quarantine?: QuarantineEntry[] } | QuarantineEntry[]>("/quarantine")
